<template>
    <section id="base">
        <div class="relative flex min-h-screen bg-gray-800 sm:pt-0">
            <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                <inertia-link v-if="$page.props.user" href="/dashboard" class="text-sm text-gray-700 dark:text-white">
                    Dashboard
                </inertia-link>

                <template v-else>
                    <inertia-link :href="route('login')" class="text-sm text-gray-700 dark:text-white">
                        Log in
                    </inertia-link>

                    <inertia-link v-if="canRegister" :href="route('register')" class="ml-4 text-sm text-gray-700 dark:text-white">
                        Register
                    </inertia-link>
                </template>
            </div>
        ...
        <footer class="footer bg-gray-900 py-6">
            <div class="container mx-auto px-4">
                <div class="grid md:grid-cols-2">
                    <div>
                        <p class="text-white text-base">Sara Pereira. Todos os direitos reservados.</p>
                    </div>
                    <div class="text-right">
                        <a class="text-white text-base mr-2" href="https://www.linkedin.com/in/saraopereira/">LinkedIn</a>
                        <a class="text-white text-base mr-2" href="https://www.instagram.com/saraopereira/">Instagram</a>
                        <a class="text-white text-base" href="https://www.facebook.com/sara.oliveirapo">Facebook</a>
                    </div>
                </div>
            </div>
        </footer>
